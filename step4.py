...
def parse_args():
    ...
    parser.add_argument('--mapping_file_1', type=str, default=f'/home/vdmosin/change_tokenization/tokenizers/matched/wiki_{dataset}_{voc_size}k_matcher_f1.tsv')
    parser.add_argument('--mapping_file_2', type=str, default=f'/home/vdmosin/change_tokenization/tokenizers/matched/wiki_{dataset}_{voc_size}k_matcher_f2.tsv')
    parser.add_argument('--source_bert_model', type=str, default=f'/home/vdmosin/change_tokenization/models/rawBert_rawTokenizer/Bert_Wiki_{voc_size}k/')
    ...
    parser.add_argument('--save_pht', type=str, default=f'/home/vdmosin/change_tokenization/models/matched_models/wiki_{dataset}_{voc_size}k/')
