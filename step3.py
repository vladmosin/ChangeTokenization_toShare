...
def parse_args():
    ...
    parser.add_argument('--wiki_vocab', type=str, default='/home/vdmosin/change_tokenization/tokenizers/wiki_32k/sp.vocab')
    parser.add_argument('--task_vocab', type=str, default='/home/vdmosin/change_tokenization/tokenizers/ohsumed_32k/sp.vocab')
    parser.add_argument('--out_vocab', type=str, default='/home/vdmosin/change_tokenization/tokenizers/matched/wiki_ohsumed_32k')
