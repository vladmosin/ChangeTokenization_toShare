...
def parse_args():
    ...
    parser.add_argument('--dataset_pth', type=str, default='/home/vdmosin/change_tokenization/datasets/sentences/wiki.txt')
    parser.add_argument('--snp_path', type=str, default='/home/vdmosin/change_tokenization/tokenizers/wiki_32k/sp.model')  #
    parser.add_argument('--vocab_size', type=int, default=32000)
    parser.add_argument('--save_path', type=str, default='/home/vdmosin/change_tokenization/models/rawBert_rawTokenizer/')
